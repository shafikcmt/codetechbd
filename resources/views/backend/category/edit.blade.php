                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.slider.update',$data->id)}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row mb-4">
                                    <div class="col-sm-6">
                                        <label class="text-danger font-weight-bold">Database Image</label>
                                        <img src="{{asset($data->image)}}" class="img-fluid ${3|rounded-top,rounded-right,rounded-bottom,rounded-left,rounded-circle,|}" alt="">
                                    </div>
                                    <div class="col-sm-6">
                                        <label class="text-danger font-weight-bold">Preview Image</label>
