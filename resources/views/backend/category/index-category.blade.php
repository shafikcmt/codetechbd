                    ...
                    <table class="table table-separate table-head-custom table-checkable" id="kt_datatable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$row->name}}</td>
                                <td><i class="text-primary fa {{$row->icon}}"></i></td>
                                ...
                                <td class="d-flex">
                                    ...
                                    @else
                                    <a id="delete" href="{{route('admin.category.delete',$row->id)}}" class="btn btn-icon btn-danger btn-hover-primary btn-xs mx-3"><i class="fa fa-trash"></i></a>
                                    @endif
                            ...
                            <div class="modal fade" id="row_status_{{$row->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('admin.category.status',$row->id)}}" method="post">
                                            @csrf
                                        ...
                                        <form action="{{route('admin.category.update',$row->id)}}" method="post">
                                            ...
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="category_name" value="{{$row->name}}" placeholder="Enter category name" class="form-control">
                                                    <div style='color:red; padding: 0 5px;'>{{($errors->has('category_name'))?($errors->first('category_name')):''}}</div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="">Category Icon</label>
                                                    <input type="text" name="category_icon" value="{{$row->icon}}" class="form-control">
                                                    <div style='color:red; padding: 0 5px;'>{{($errors->has('category_icon'))?($errors->first('category_icon')):''}}</div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="">Category Description</label>

                                                    <textarea class="form-control" name="description" placeholder="Enter your category description">
                                                    {!! $row->description !!}
                                                    </textarea>
        ...
        <div class="modal-content">
            ...
            <form action="{{route('admin.category.store')}}" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="">Category Icon</label>
                        <input type="text" name="category_icon" placeholder="Category Icon name" class="form-control">
                        <div style='color:red; padding: 0 5px;'>{{($errors->has('category_icon'))?($errors->first('category_icon')):''}}</div>
                    </div>
                    <div class="form-group">
                        <label for="">Category Description</label>

                        <textarea class="form-control" name="description" placeholder="Enter your category description"></textarea>
                        <div style='color:red; padding: 0 5px;'>{{($errors->has('category_icon'))?($errors->first('category_icon')):''}}</div>
                    </div>
