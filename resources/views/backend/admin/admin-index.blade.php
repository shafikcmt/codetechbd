            ...
            <div class="card card-custom">
                <div class="card-header flex-wrap py-5">
                    ...
                    <div class="card-toolbar">
                        ...
                        <!--end::Dropdown-->
                        <!--begin::Button-->
                        <a href="{{route('admin.admin.create')}}" class="btn btn-primary font-weight-bolder">
                            <span class="svg-icon svg-icon-md">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                   <a href="{{route('admin.admin.edit',$row->id)}}" class="btn btn-icon btn-info btn-hover-primary btn-xs mx-3">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                  
                                    <a id="delete" href="{{route('admin.admin.delete',$row->id)}}" class="btn btn-icon btn-danger btn-hover-primary btn-xs mx-3">
